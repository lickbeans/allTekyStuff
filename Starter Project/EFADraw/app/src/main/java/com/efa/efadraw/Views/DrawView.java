...
public class DrawView extends LinearLayout {
    ...
    public void strokeTapped() {
        ...
        strokeWidthDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                drawingCanvas.strokeWidthChanged(strokeWidthDialog.width);
            }
        });
    ...
    public void colorTapped() {
        final ColorPickerDialog colorPickerDialog = new ColorPickerDialog(context, drawingCanvas.color);
        colorPickerDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                drawingCanvas.colorChanged(colorPickerDialog.color);
            }
        });
    ...
    public void saveTapped() {
        ...
        String image = MediaStore.Images.Media.insertImage(context.getContentResolver(),
                bitmap, UUID.randomUUID().toString() + ".png", "new image");

        if (image != null) {
            Toast.makeText(context, "Drawing Saved", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(context, "Could not save drawing", Toast.LENGTH_LONG).show();
        }
